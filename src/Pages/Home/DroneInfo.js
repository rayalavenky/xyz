    ...
    <Container className="text-center mt-5">
      ...
      <Row className="mt-5">
        <Col md="4">
          <Row>
            <Col md="12">
              <h6 className="drone_title fs-5">Highest Endurance Time</h6>
              <p className="droneInfo fs-5">
            ...
            <Col md="12">
              <h6 className="drone_title fs-5">Environmental perception sensors</h6>
              <p className="droneInfo fs-5">
      ...
      <Button className="getButton rounded-pill px-5 mt-3">Get Started</Button>
    </Container>
  );
};
